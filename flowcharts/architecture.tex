...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    \draw [arrow] (input) -- node[anchor=center, fill=white, yshift=0.125cm]{digital signal} (hpss);
    ...
    \node (percussion) [process, below = of viterbi] {Percussion generator};
    ...
    \node (sample_data) [document, below = of melody, yshift=0.75cm] {Custom sample library};
    ...
    \draw [arrow] (soundfont) |- node[anchor=center, fill=white, yshift=-4.5cm]{soundfont} (midi);
    \draw [arrow, preaction={draw=white, -, line width=12pt}] (percussion) |- node[anchor=center, fill=white, xshift=3.3cm, text width=2cm]{instrumental parts} (midi);
    \draw [arrow] (piano) |- (midi);
    \draw [arrow, preaction={draw=white, -, line width=12pt}] (voice) |- node[anchor=center, fill=white, xshift=3.3cm]{vocal parts} (sample);
