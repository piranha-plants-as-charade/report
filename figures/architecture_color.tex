\begin{tikzpicture}[
    ...
    \node (instruments bridge) [arrow bridge, right=of instruments] {};
    \node (voice bridge) [arrow bridge, above=of instruments bridge, yshift=0.75cm] {};
    ...
    %% AUDIO EXPORT
    \node (sample) [block, right=of voice bridge, xshift=0.725cm] {Sample-based export};
    \node (midi) [block, right=of instruments, xshift=2.555cm] {MIDI-based export};
